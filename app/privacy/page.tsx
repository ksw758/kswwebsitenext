  ...
  return (
    <main style={{ maxWidth: 760, margin: '0 auto', padding: '60px 24px 100px', fontFamily: 'Georgia, serif' }}>
      ...
      {section('제7조 (쿠키 및 광고 추적기술의 사용)', <>
        <p>① 사업자는 웹사이트 이용 현황 분석 및 온라인 광고 최적화를 위해 쿠키(Cookie) 및 이와 유사한 추적기술(예: Meta(Facebook) 픽셀 등)을 사용할 수 있습니다.</p>
        ...
        <p>④ Meta 픽셀을 통해 수집·처리되는 정보는 Meta의 개인정보처리방침(https://www.facebook.com/privacy/policy/)의 적용을 받습니다.</p>
      </>)}

      {section('제8조 (개인정보 보호책임자)', <>
